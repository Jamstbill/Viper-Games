...
<nav class="bg"> 
  <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div class="relative flex h-16 items-center justify-between padding-top-100">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start pt-100">
        <div class="flex flex-shrink-0 items-center pt-100">
         <a href="/"><img class="viperLogo" width="190px" src="/images/logo-removebg-preview.png" alt="Your Company"></a>
        </div>
        ...
        <div>
          ...
          <div class="logoText">
           <img class="viperLogoText" width="190px" src="/images/logotext.png" alt="Your Company">
          </div>
        </div>
